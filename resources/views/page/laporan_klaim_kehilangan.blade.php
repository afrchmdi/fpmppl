  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-sm-4"><p>Lokasi Temuan</p></div>
          <div class="col-sm-1" style="padding-right:0; padding-left:0; width:1%">:</div>
        ...
        <div class="row">
          <div class="col-sm-4"><p>Waktu Temuan</p></div>
          <div class="col-sm-1" style="padding-right:0; padding-left:0; width:1%">:</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-sm-1" style="padding-right:0; padding-left:0; width:1%">:</div>
          <div class="col-sm-7">Contoh Klaim Kehilangan Barang Temuan Klaim Kehilangan Barang Temuan Klaim Kehilangan Barang Temuan Klaim Kehilangan Barang Temuan  Barang Klaim Kehilangan Barang Temuan Klaim Kehilangan Barang Temuan Klaim Kehilangan Barang Temuan</div>
        </div>
        <div class="row">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Penerimaan Klaim Kehilangan Barang Temuan</h4>
      </div>
      <div class="modal-body">
        <p>Apakah kamu yakin <b>menerima</b> klaim kehilangan barang temuan ini?</p>
      </div>
      <div class="modal-footer">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Penolakan Klaim Kehilangan Barang Temuan</h4>
      </div>
      <div class="modal-body">
        <p>Apakah kamu yakin <b>menolak</b> klaim kehilangan barang temuan ini?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-warning pull-left" data-dismiss="modal">Tidak</button>
        <a href="/laporan.klaim.penemuan">
